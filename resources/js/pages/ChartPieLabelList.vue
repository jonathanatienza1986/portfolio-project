...
const chartData = [
    ...
    { date: new Date("2024-04-02"), desktop: 97, mobile: 180, garry: 564 },
    { date: new Date("2024-04-03"), desktop: 167, mobile: 120, garry: 564  },
    { date: new Date("2024-04-04"), desktop: 242, mobile: 260 , garry: 564 },
    { date: new Date("2024-04-05"), desktop: 373, mobile: 290 , garry: 564 },
    { date: new Date("2024-04-06"), desktop: 301, mobile: 340 , garry: 564 },
    { date: new Date("2024-04-07"), desktop: 245, mobile: 180, garry: 564 },
    { date: new Date("2024-04-08"), desktop: 409, mobile: 320 , garry: 564 },
...
const svgDefs = `
  ...
  <linearGradient id="fillMobile" x1="0" y1="0" x2="0" y2="1">
   ...
   <linearGradient id="fillGarry" x1="0" y1="0" x2="0" y2="1">
    <stop
      offset="5%"
      stop-color="violet"
      stop-opacity="0.8"
        ...
        <CardContent class="px-2 pt-4 sm:px-6 sm:pt-6 pb-4">
            <ChartContainer :config="chartConfig" class="aspect-auto h-[250px] w-full" :cursor="false">
                ...
                <VisXYContainer :data="filterRange" :svg-defs="svgDefs" :margin="{ left: -40 }" :y-domain="[0, 1200]">
                    ...
                    <VisArea :x="(d: Data) => d.date" :y="[(d: Data) => d.mobile, (d: Data) => d.desktop, (d: Data) => d.garry]"
                        :color="(d: Data, i: number) => ['url(#fillMobile)', 'url(#fillDesktop)', 'url(#fillGarry)'][i]" :opacity="0.6" />

                    <VisLine :x="(d: Data) => d.date" :y="[(d: Data) => d.mobile, (d: Data) => d.mobile + d.desktop, (d: Data) => d.garry + d.mobile + d.desktop]"
                        :color="(d: Data, i: number) => [chartConfig.mobile.color, chartConfig.desktop.color, chartConfig.garry.color][i]"
                        :line-width="1" />
                    ...
                    <ChartCrosshair :template="componentToString(chartConfig, ChartTooltipContent, {
                        ...
                        :color="(d: Data, i: number) => [chartConfig.mobile.color, chartConfig.desktop.color, chartConfig.garry.color][i % 15]" />
                </VisXYContainer>
