...
const next_page = () => {
    ...
    isDisabled.value = true;
    const form_payload = useForm();
    form_payload.get(customer.edit(form.value.id).url, {
        //----------------------------------------- force ajax parameters
        preserveScroll: true,
        preserveState: true,
    });
    ...
    <div class=" z-0 h-full w-full overflow-auto p-0 m-0 justify-center">
        ...
        <div class="p-8 flex flex-col w-full lg:w-[90%] gap-7">
            ...
            <div class="flex flex-col lg:flex-row gap-6">
                Other Gov't ID
                <div class="lg:w-[65%] flex flex-col gap-2 mb-0 border-2 rounded-xl min-w-72 overflow-hidden">
                    <img :src="file_base642" alt="x" style="object-fit: cover; margin: auto;  height: 100%;" />
                </div>
                <div class="lg:w-[35%]">
                    <div class="w-full flex flex-col gap-2 mb-6">
            ...
            <div class="flex flex-col lg:flex-row gap-6">
                <div class="w-full flex flex-col gap-2 mb-0">
                    ...
                    <Input readonly type="text" placeholder="ex. Cacho, Garry M." name="name" v-model="form.name" />
                </div>
                <div class="w-full flex flex-col gap-2 mb-0">
            ...
            <div class="flex flex-col lg:flex-row gap-6">
                ...
                <div class="w-full flex flex-col gap-2 mb-0">
                    ...
                    <Input readonly type="tel" placeholder="ex. 0999737423" name="phone_number" v-model="form.phone" />
                </div>
            </div>
            ...
            <div class="flex flex-col lg:flex-row gap-6">
                Portrait Photo
                <div class="lg:w-[65%] flex flex-col gap-2 mb-0 border-2 rounded-xl min-w-72 overflow-hidden">
                    <img :src="file_base641" alt="x" style="object-fit: cover; margin: auto;  height: 100%;" />
                </div>
            </div>
