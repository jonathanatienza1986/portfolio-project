...
const prev_page = () => {
    ...
    const form_payload = useForm({ id: form.value.id });
    form_payload.get(complaint.index().url);
};
...
const next_page = () => {
    ...
    isDisabled.value = true;
    const form_payload = useForm({ id: form.value.id });
    form_payload.get(complaint.edit(form_payload.id).url);
};
defineOptions({
    layout: {
        breadcrumbs: [
...
const qrValue = ref(props.complaint.id.toString());
</script>

<template>

    <Head title="complaint.show" />
        ...
        <div class="p-8 flex flex-col w-full lg:w-[90%] gap-7">
            ...
            <div class="flex gap-4 items-center">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                    ...
                    class="lucide lucide-audio-waveform-icon lucide-audio-waveform">
                    <path
            ...
            <div class="flex flex-col lg:flex-row gap-6">
                ...
                <div class="lg:w-[65%] flex flex-col gap-2 mb-0 border-2 rounded-xl min-w-72 overflow-hidden">
                    <img :src="form.picture" alt="x" style="object-fit: cover; margin: auto;  height: 100%;" />
                </div>
                <div class="lg:w-[35%]">
            ...
            <div class="flex flex-col lg:flex-row gap-6">
                QR Code
                <div class="flex flex-col gap-2 mb-0 border-2 p-4 bg-white overflow-hidden">
                    <QRCodeVue3 class="z-0" :width="300" :height="300"
                        :value="qrValue"
                        :qrOptions="{ typeNumber: 0, mode: 'Byte', errorCorrectionLevel: 'H' }"
                        :imageOptions="{ hideBackgroundDots: true, imageSize: 0.4 }" :dotsOptions="{
                            //type: 'dots',
                            //color: '#26249a',
                            color: '#0',
                            gradient: {
            ...
            <div class="flex flex-col lg:flex-row gap-6">
                ...
                <div class="w-full flex flex-col gap-2 mb-0">
                    ...
                    <Input readonly type="text" placeholder="ex. 4564765745" name="accountnumber"
            ...
            <div class="flex flex-col lg:flex-row gap-6">
                <div class="w-full lg:w-[35%] flex flex-col gap-2 mb-0">
                    ...
                    <Input readonly type="text" placeholder="ex. sigepalong ang transformer" name="complaint"
                ...
                <div class="w-full lg:w-[65%] flex flex-col gap-2 mb-0">
                    ...
                    <Input readonly type="text" placeholder="ex. daghay ga reklamo na kunsumante" name="description"
