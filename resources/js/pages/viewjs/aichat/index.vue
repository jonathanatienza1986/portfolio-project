...
const new_item = () => {
    ...
    form_payload.get(aichat.create().url);
}
</script>
                            ...
                            <ul class="grid w-[200px] gap-4">
                                <li>
                                    <NavigationMenuLink as-child>
                                        <a :href="aichat.create().url" class="flex-row items-center gap-2">
                                            <CircleHelpIcon />
                                            Start New Chat head
                                        </a>
                                    </NavigationMenuLink>
                                    <NavigationMenuLink as-child>
                                        <a :href="aichat.index().url" class="flex-row items-center gap-2">
                                            <CircleIcon />
                                            List of Chat heads
                                        </a>
                                    </NavigationMenuLink>
            ...
            <table ref="table_header">
                ...
                <tbody>
                    <tr class="align-middle text-justify p-8 border" v-for="(item, index) in chatbots.data"
                        ...
                        <td class="p-4">
                            <a :href="aichat.show(item.id).url">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
